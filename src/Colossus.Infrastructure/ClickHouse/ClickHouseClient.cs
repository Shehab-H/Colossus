...
/// <summary>Thin wrapper over the ClickHouse HTTP interface (port 8123): DDL, INSERT…SELECT, and
/// FORMAT Parquet extracts. Plain HTTP keeps the dependency surface tiny.</summary>
