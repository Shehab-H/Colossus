...
describe('foldTile', () => {
  // Two marks; m0 has apex(q1,q2) + zenith(q1) facts, m1 has one zenith(q1) fact.
  const companion: CompanionData = {
    rowCount: 4,
    mk: ['m0', 'm0', 'm0', 'm1'],
    dim: { operator: ['apex', 'apex', 'zenith', 'zenith'] },
    temporal: { quarter: ['2025-01-01', '2025-04-01', '2025-01-01', '2025-01-01'] },
    partial: {
  ...
  const fold = (ctx: FoldContext) => foldTile(companion, measures, ctx, 2, markIndex, domains);
